...
public class DataSanPham extends SQLiteOpenHelper {
    ...
    public static String TB_YEUTHICH_PHANTRAM = "PHANTRAM";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String tbYeuThich = "CREATE TABLE " + TB_YEUTHICH + " (" + TB_YEUTHICH_MASP + " INTEGER PRIMARY KEY , "
                + TB_YEUTHICH_TENSP + " TEXT, " + TB_YEUTHICH_GIATIEN + " REAL, " +TB_YEUTHICH_HINHANH + "  BLOB, "+ TB_YEUTHICH_PHANTRAM +" INTEGER);";
