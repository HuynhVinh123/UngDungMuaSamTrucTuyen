package com.example.huynhvinh.applazada_java.model.HienThiSanPhamTheoDanhMuc;
...
public class HienThiSanPhamTheoDanhMucModel {
    ...
    public List<SanPham> LayDanhSachSanPhamTheoMaLoai(int  masp,String tenmang,String tenham,int limit){
        ...
        hashMaLoai.put("maloaisp", String.valueOf(masp));
    ...
    public List<SanPham> LayDanhSachTatSanPhamTheoMaLoai(int  masp,String tenmang,String tenham){
